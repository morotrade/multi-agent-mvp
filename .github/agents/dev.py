...
def generate_implementation(issue_details: dict) -> str:
    ...
    try:
        ...
        prompt_template = \"\"\"# Ruolo: Senior Developer
...
**Titolo:** {issue_details['title']}
**Descrizione:** {issue_details.get('body', 'Nessuna descrizione')}

## ISTRUZIONI:
1. Implementa SOLO ciò che è specificato nell'issue
2. Segui le convenzioni di codice del progetto
3. Mantieni le modifiche minimali e focalizzate
4. Non modificare file non rilevanti

## OUTPUT:
Fornisci il codice in un singolo blocco `diff. Non includere altro testo.
...
def create_pr(branch_name: str, issue_number: str, issue_title: str) -> dict:
    ...
    pr_data = {
        ...
        \"head\": branch_name,
        \"base\": \"main\",
        \"body\": f\"\"\"Implementazione automatica dell'issue #{issue_number}

## Changes
- Implementata richiesta: {issue_title}
